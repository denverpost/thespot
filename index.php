				...
				<div id="post-<?php the_ID(); ?>">
					...
					<div id="sidebar">
						...
						<div class="feedback listingpage">
							...
							<div class="articletools"><div class="fb-like" data-href="<?php the_permalink(); ?>" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false"></div></div>
